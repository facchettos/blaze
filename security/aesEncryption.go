...
func StreamReaderDecrypt(readPipe *io.PipeReader, destinationFile string, key []byte) {
	...
	outFile, err := os.OpenFile(destinationFile+".tmp", os.O_WRONLY|os.O_CREATE|os.O_TRUNC, 0600)
